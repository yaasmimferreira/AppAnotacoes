...
// Define uma função para editar o texto
function editItem(i) {
    const newText = prompt("Digite o novo texto:", itensDB[i].item);
    if (newText !== null) {
...
document.getElementById('inp_busca').addEventListener('keypress', function() {
